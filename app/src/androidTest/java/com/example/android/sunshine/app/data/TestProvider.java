...
import com.example.asaldanha.sunshine.app.data.WeatherProvider;
...
//
    ...
    public void testGetType() {
        ...
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherContract.WeatherEntry.CONTENT_TYPE",
...
//
        ...
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherContract.WeatherEntry.CONTENT_TYPE",
                WeatherContract.WeatherEntry.CONTENT_TYPE, type);
//
        ...
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE",
...
//
        ...
        assertEquals("Error: the LocationEntry CONTENT_URI should return WeatherContract.LocationEntry.CONTENT_TYPE",
...
//
        TestUtilities.validateCursor("testInsertReadProvider. Error validating WeatherContract.LocationEntry.",
                cursor, testValues);
//
        // Fantastic.  Now that we have a location, add some weather!
        ContentValues weatherValues = TestUtilities.createWeatherValues(locationRowId);
...
//        );
//
//        TestUtilities.validateCursor("testBulkInsert. Error validating WeatherContract.LocationEntry.",
//                cursor, testValues);
//
