package com.example.asaldanha.sunshine.app.sync;
...
*/
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            Cursor cur = mContentResolver.query(weatherForLocationUri,
    ...
    private void notifyWeather() {
        ...
        // checki if notifications have been switched on or off
        if (Utility.getPreferredNotification(context)){
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    String contentText = String.format(context.getString(R.string.format_notification),
                            desc,
                            Utility.formatTemp(context, high),
                            Utility.formatTemp(context, low));
